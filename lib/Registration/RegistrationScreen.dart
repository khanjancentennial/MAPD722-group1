                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Consumer<RegistrationProvider>(
                            builder: (_, healthCare, child) => Row(
                              children: [
                                InkWell(
                                  onTap: () {
                                    healthCare.healthCareCheck("Doctor");
                                  },
                                  child: Row(
                                    children: [
                                      healthCare.isDoctor
                                ...
                                InkWell(
                                  onTap: () {
                                    healthCare.healthCareCheck("Nurse");
                                  },
                                  child: Row(
                                    children: [
                                      healthCare.isNurse
                          ...
                          isFirstTime?
                          Consumer<RegistrationProvider>(
                              builder: (_, healthCare, child) =>
                              healthCare.isDoctor == false || healthCare.isNurse == false ?

                              Padding(
                                padding: const EdgeInsets.only(top: 10,left: 13),
                                child: Text("Please select health care provider",
                                  style: AppUtils.instance.textStyle(
                                      color: AppColors.darkRed
                                  ),
                                ),
