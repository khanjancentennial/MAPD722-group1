...
class ClinicalkTestProvider extends ChangeNotifier {
  LoginModel? loginData;
  bool isLoading=false;

  ClinicalTestModel? clinicalTestModel;
  ...
  //         AppUtils.instance.addPref(PreferenceKey.stringKey, PreferenceKey.prefUserType,loginData!.user!.healthcareProvider.toString());
...
// hideShow(index){
//   clinicalTestModel![index].isExpanded = !clinicalTestModel![index].isExpanded;
// }
